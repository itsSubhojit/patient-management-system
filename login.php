...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            $stmt = $pdo->prepare("SELECT id, username, password, full_name, role, email FROM users WHERE (username = ? OR email = ?) AND is_active = 1");
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                <h2><i class="fas fa-user-md"></i> <?php echo SITE_NAME; ?></h2>
